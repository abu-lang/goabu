...
func TestSingleNode(t *testing.T) {
	...
	e, err := semantics.NewMuSteelExecuter(memory, nil, communication.MakeMemberlistAgent(memory.ResourceNames(), 8000, config.TestsLogConfig), config.TestsLogConfig)
	if err != nil {
		t.Fatal(err)
	}
...
func TestTwoNodes(t *testing.T) {
	...
	t.Run("TestTwoNodes#1", func(t *testing.T) {
		e1, err := semantics.NewMuSteelExecuter(memory, rules, communication.MakeMemberlistAgent(memory.ResourceNames(), 9001, config.TestsLogConfig), config.TestsLogConfig)
		if err != nil {
			t.Fatal(err)
		}
		t.Parallel()
	...
	t.Run("TestTwoNodes#2", func(t *testing.T) {
		t.Parallel()
		e2, err := semantics.NewMuSteelExecuter(memory, rules, communication.MakeMemberlistAgent(memory.ResourceNames(), 9002, config.TestsLogConfig, "127.0.0.1:9001"), config.TestsLogConfig)
		if err != nil {
			t.Fatal(err)
		}
		e2.Input("lorem = 10; ")
...
func TestThreeNodes(t *testing.T) {
	...
	t.Run("TestThreeNodes#1", func(t *testing.T) {
		e1, err := semantics.NewMuSteelExecuter(memory, rules, communication.MakeMemberlistAgent(memory.ResourceNames(), 10001, config.TestsLogConfig), config.TestsLogConfig)
		if err != nil {
			t.Fatal(err)
		}
		t.Parallel()
	...
	t.Run("TestThreeNodes#2", func(t *testing.T) {
		...
		e2, err := semantics.NewMuSteelExecuter(memory, rules, communication.MakeMemberlistAgent(memory.ResourceNames(), 10002, config.TestsLogConfig, "127.0.0.1:10001"), config.TestsLogConfig)
		if err != nil {
			t.Fatal(err)
		}
		t.Parallel()
	...
	t.Run("TestThreeNodes#3", func(t *testing.T) {
		t.Parallel()
		memory.Float["ipsum"] = 3.0
		e3, err := semantics.NewMuSteelExecuter(memory, rules, communication.MakeMemberlistAgent(memory.ResourceNames(), 10003, config.TestsLogConfig, "127.0.0.1:10001"), config.TestsLogConfig)
		if err != nil {
			t.Fatal(err)
		}
		e3.Input("ipsum = 6.0;")
